...
class Place_TestCase(unittest.TestCase):
    ...
    def test_attribute_in(self):
        ...
        self.assertIn("city_id", a.__dict__)
        self.assertIn("user_id", a.__dict__)
        self.assertIn("description", a.__dict__)
        self.assertIn("number_rooms", a.__dict__)
        self.assertIn("number_bathrooms", a.__dict__)
        self.assertIn("max_guest", a.__dict__)
        self.assertIn("price_by_night", a.__dict__)
        self.assertIn("latitude", a.__dict__)
        self.assertIn("longitude", a.__dict__)
        self.assertIn("amenity_ids", a.__dict__)
